...
class Prisma:
    similarity: 'actions.SimilarityActions'
    closestsimilarity: 'actions.ClosestSimilarityActions'
    ...
    def __init__(
        ...
        *,
        ...
        self.similarity = actions.SimilarityActions(self, models.Similarity)
        self.closestsimilarity = actions.ClosestSimilarityActions(self, models.ClosestSimilarity)
...
class Batch:
    similarity: 'SimilarityBatchActions'
    closestsimilarity: 'ClosestSimilarityBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.similarity = SimilarityBatchActions(self)
        self.closestsimilarity = ClosestSimilarityBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ClosestSimilarityBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
