...
export function useUserCollectionsQuery(
  options: Omit<Urql.UseQueryArgs<UserCollectionsQueryVariables>, 'query'>
) {
  return Urql.useQuery<UserCollectionsQuery>({
...
export function useCollectionsQuery(
  ...
  return Urql.useQuery<CollectionsQuery>({
...
export function useFeaturedQuery(
  options?: Omit<Urql.UseQueryArgs<FeaturedQueryVariables>, 'query'>
) {
